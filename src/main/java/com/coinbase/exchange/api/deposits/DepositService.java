...
public class DepositService {
     ...
     * @return
     */
    public Mono<PaymentResponse> depositViaPaymentMethod(BigDecimal amount, String currency, String paymentMethodId) {
     ...
     * @return
     */
    public Mono<PaymentResponse> coinbaseDeposit(BigDecimal amount, String currency, String coinbaseAccountId) {
