...
public class WithdrawalsService {
    ...
    public Mono<PaymentResponse> makeWithdrawalToPaymentMethod(BigDecimal amount, String currency, String paymentMethodId) {
        return makeWithdrawal(amount, currency, paymentMethodId, PAYMENT_METHOD);
    }

    // TODO untested - needs coinbase account ID to work.
    public Mono<PaymentResponse> makeWithdrawalToCoinbase(BigDecimal amount, String currency, String paymentMethodId) {
        return makeWithdrawal(amount, currency, paymentMethodId, COINBASE);
    }

    // TODO untested - needs a crypto currency account address
    public Mono<PaymentResponse> makeWithdrawalToCryptoAccount(BigDecimal amount, String currency, String cryptoAccount) {
        return makeWithdrawal(amount, currency, cryptoAccount, CRYPTO);
    }

    private Mono<PaymentResponse> makeWithdrawal(BigDecimal amount,
                                                String currency,
